...
printBalances();
passIfTxStatusError(sendContribution2_1Tx, sendContribution2Message + " - ac3 2,000 ETH - Expecting Failure - Over Whitelist");
passIfTxStatusError(sendContribution2_2Tx, sendContribution2Message + " - ac4 2,000 ETH - Expecting Failure - Not Whitelisted");
printCrowdsaleContractDetails();
printTokenContractDetails();
console.log("RESULT: ");
...
printBalances();
failIfTxStatusError(sendContribution3_1Tx, sendContribution3Message + " - ac3 1,000 ETH = 140,000 PRIX");
passIfTxStatusError(sendContribution3_2Tx, sendContribution3Message + " - ac4 1,000 ETH - Expecting Failure - Not Whitelisted");
printCrowdsaleContractDetails();
printTokenContractDetails();
console.log("RESULT: ");
...
printBalances();
failIfTxStatusError(sendContribution4_1Tx, sendContribution4Message + " - ac3 1,200 ETH = 168,000 PRIX");
failIfTxStatusError(sendContribution4_2Tx, sendContribution4Message + " - ac4 1,200 ETH = 168,000 PRIX");
printCrowdsaleContractDetails();
printTokenContractDetails();
console.log("RESULT: ");
...
printBalances();
failIfTxStatusError(sendContribution5_1Tx, sendContribution5Message + " - ac3 26,871 ETH = 3,761,940 PRIX");
failIfTxStatusError(sendContribution5_2Tx, sendContribution5Message + " - ac4 26,871 ETH = 3,761,940 PRIX");
printCrowdsaleContractDetails();
printTokenContractDetails();
console.log("RESULT: ");
...
printBalances();
passIfTxStatusError(moveToken1_1Tx, moveToken1Message + " - transfer 0.1 PRIX ac3 -> ac5. CHECK for NO movement");
failIfTxStatusError(moveToken1_2Tx, moveToken1Message + " - approve 3 PRIX ac4 -> ac6");
passIfTxStatusError(moveToken1_3Tx, moveToken1Message + " - transferFrom 3 PRIX ac4 -> ac7 by ac6. CHECK for NO movement");
printCrowdsaleContractDetails();
printTokenContractDetails();
console.log("RESULT: ");
...
failIfTxStatusError(finishCrowdsale1_3Tx, finishCrowdsaleMessage + " - Withdraw ETH");
printCrowdsaleContractDetails();
printTokenContractDetails();
console.log("RESULT: ");
...
printBalances();
failIfTxStatusError(moveToken2_1Tx, moveToken2Message + " - transfer 0.1 PRIX ac3 -> ac5. CHECK for movement");
failIfTxStatusError(moveToken2_2Tx, moveToken2Message + " - approve 3 PRIX ac4 -> ac6");
failIfTxStatusError(moveToken2_3Tx, moveToken2Message + " - transferFrom 3 PRIX ac4 -> ac7 by ac6. CHECK for movement");
printCrowdsaleContractDetails();
printTokenContractDetails();
console.log("RESULT: ");
...
printBalances();
failIfTxStatusError(founderMoveToken1_1Tx, founderMoveTokenMessage);
printCrowdsaleContractDetails();
printTokenContractDetails();
console.log("RESULT: ");
